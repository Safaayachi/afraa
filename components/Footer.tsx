...
const Footer = () => {
  return (
    <footer className="relative h-full w-full bg-secondary px-8  lg:px-16">
      <div className="relative flex h-full w-full justify-start px-4">
        <div className="relative flex h-full w-full items-center justify-start border-b border-solid border-b-darkTint py-8">
          <div className="relative flex h-16 w-96 flex-row gap-2">
            <Link passHref href={"/"}>
              <div className="flex h-full w-1/2 items-center justify-center cursor-pointer bg-tint text-2xl font-bold text-secondary">
                إحجز الان
              </div>
            </Link>
      ...
      <div className="relative flex h-full w-full flex-col p-4 lg:flex-row-reverse">
      ...
      <div className="flex h-full w-full flex-col justify-between gap-6 py-8 px-4 lg:flex-row-reverse">
